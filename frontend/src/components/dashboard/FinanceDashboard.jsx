...
const FinanceDashboard = () => {
  ...
  if (isLoading || currencyLoading) return <p>Loading...</p>;
  if (error) return <p>Error loading financial data.</p>;
  if (currencyError) console.error("Currency data error:", currencyError);
  ...
  const feesData = availableCurrencies.map((currency) => {
    const currencyInfo = currencyStats.find((stat) => stat._id === currency);
    return {
      currency,
