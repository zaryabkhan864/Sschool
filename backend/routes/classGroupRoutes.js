...
import {
  ...
  getClassGroupStudents, // ✅ new controller
  updateClassGroup,
  deleteClassGroup,
...
router.route("/class-groups/:id/students").get(getClassGroupStudents);
...
router
  .route("/teacher/class-groups/courses")
...
router
  .route("/teacher/class-groups/courses-by-teacher")
